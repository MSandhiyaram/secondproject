...
public class StreamApi5 
{
	...
	public static void main(String[] args) 
	{
		...
		//Mac : command + /
				...
				al.add(new StudentInfo(1,"Sandhiya",450));
				al.add(new StudentInfo(3,"Ramya",670));
				al.add(new StudentInfo(2,"Renu",340));
				al.add(new StudentInfo(5,"Uma",900));
				al.add(new StudentInfo(7,"Narmadha",750));
				//1*2*3*5*7
				double  sum=0;
